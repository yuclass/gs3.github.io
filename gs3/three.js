...
lib.ssMetadata = [
		{name:"three_atlas_1", frames: [[0,0,546,397],[548,0,395,400]]}
];
...
(lib.Behind = function() {
	this.initialize(ss["three_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	this.shape.graphics.f("#967C60").s().p("EhK/AvfMAAAhe9MCV/AAAMAAABe9g");
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-88,-86,0.4297,0.464);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Cursor_1, new cjs.Rectangle(-88,-86,169.8,185.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(-93,-10,0.96,1.0925);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib.Behind_1, new cjs.Rectangle(-93,-10,524.2,433.8), null);
...
}).prototype = getMCSymbolPrototype(lib._2, new cjs.Rectangle(-160,-142,169.8,185.6), null);
...
if (reversed == null) { reversed = false; }
	...
	this.instance.setTransform(1062.15,332.2,2.1521,1.2023,0,0,0,400.6,266.4);

	this.timeline.addTween(cjs.Tween.get(this.instance).wait(1));

	this._renderFirstFrame();

}).prototype = getMCSymbolPrototype(lib._1, new cjs.Rectangle(-0.1,-0.1,1128,521.5), null);
...
if (reversed == null) { reversed = false; }
	...
	this.scratchable.setTransform(-13,-659.65,1,0.9807,0,0,0,0,-0.1);
	...
	this.instance_5.cache(-2,-2,1132,526);
...
p.nominalBounds = new cjs.Rectangle(479.9,251.4,481.70000000000005,326.1);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/three_atlas_1.png", id:"three_atlas_1"}
	],
	preloads: []
};
